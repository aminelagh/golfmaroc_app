...
class UpdatePromotionNotification extends Notification
{
  use Queueable;
  ...
  public function toMail($notifiable)
  {
      return (new MailMessage)
                  ->subject('Modification des cordonnées d\'une Promotion ')
                  ->line('Bienvenue dans GolfMaroc-APP votre application de gestion des points de vente du groupe GolfMaroc .')
                  ->line('Nous vous informons qu\'une modification des cordonnées d\'une promotion a eu lieu dans notre application ')

...
class AddStockINNotification extends Notification
{
    use Queueable;
    protected $user;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject('Nouvelle Entree de Stock')
        ->line('Bienvenue dans GolfMaroc-APP votre application de gestion des points de vente du groupe GolfMaroc .')
        ->line('Nous vous informons qu\'une nouvelle entrée de stock a été effectué au magasin '. \App\Models\Magasin::getLibelle($this->user->id_magasin))

...
@section('title') transfert depuis le magasin: {{ $magasin_destination->libelle }}  @endsection

@section('main_content')

    <h3 class="page-header">Transfert depuis le magasin: <strong>{{ $magasin_destination->libelle }}</strong></h3>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ Route('magas.magasin',['p_id'=> $magasin_destination->id_magasin]) }}">{{ $magasin_destination->libelle }}</a></li>
        <li class="breadcrumb-item active">Transfert depuis le magasin: <strong>{{ $magasin_destination->libelle }}</strong></li>
    </ol>

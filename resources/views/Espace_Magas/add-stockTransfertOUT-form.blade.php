...
@section('title') transfert vers le magasin: {{ $magasin_destination->libelle }}  @endsection

@section('main_content')

    <h3 class="page-header">Transfert vers le magasin: <strong>{{ $magasin_destination->libelle }}</strong></h3>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Transfert vert le magasin: <strong>{{ $magasin_destination->libelle }}</strong></li>
    </ol>

...
@section('main_content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('admin.ventes') }}">Liste des ventes</a></li>
    </ol>
                    ...
                    @else
                        @foreach( $data as $item )
                            <tr>
                                ...
                                <td align="right">{{ \App\Models\Vente::getNombrePieces($item->id_vente) }}
                                    pieces
                                </td>
                                <td align="center">
                                    ...
                                    <a href="{{ Route('admin.vente',['p_id' => $item->id_vente ]) }}"

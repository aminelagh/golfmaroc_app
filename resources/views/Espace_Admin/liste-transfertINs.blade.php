...
@section('title') Transferts vers le magasin principal @endsection

@section('main_content')
    <h3 class="page-header">Transferts vers le magasin principal </h3>

    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
        <li class="breadcrumb-item ">Gestion des transactions</li>
        <li class="breadcrumb-item active"><a href="{{ route('admin.transfertINs') }}">Liste des transferts vers le
                        ...
                        @foreach( $data as $item )
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="{{ Route('admin.transfertIN',['p_id' => $item->id_transaction ]) }}"

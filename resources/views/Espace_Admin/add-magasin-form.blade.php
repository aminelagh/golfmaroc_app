...
@section('main_content')
    ...
    <h3 class="page-header">Ajouter un magasin</h3>

    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">
            <a href="{{ Route('admin.magasins') }}"> Liste des magasins</a>
        </li>
        <li class="breadcrumb-item active">Création d'un magasin</li>
    </ol>

    <form role="form" method="post" action="{{ Route('admin.submitAddMagasin') }}">
        {{ csrf_field() }}

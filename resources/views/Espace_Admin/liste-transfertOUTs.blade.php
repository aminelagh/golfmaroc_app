...
@section('title') Transferts depuis le magasin principal @endsection

@section('main_content')
    <h3 class="page-header">Transferts depuis le magasin principal </h3>

    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
        <li class="breadcrumb-item ">Gestion des transactions</li>
        <li class="breadcrumb-item active"><a href="{{ route('admin.transfertOUTs') }}">Liste des transferts depuis le
                magasin principal </a></li>
    </ol>
        ...
        <div class="table-responsive">
            <div class="col-lg-12">
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    @if( $data->isEmpty() )
                        <tr>
                            <td colspan="6" align="center"><i>Aucun transfert de stock</i></td>
                        </tr>
                    @else
                        @foreach( $data as $item )
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.user',[$item->id_user]) }}">{{ $item->nom }} {{ $item->prenom }}</a>
                                </td>
                                <td>
                                    <a href="{{ route('admin.magasin',[$item->id_magasin]) }}">{{ $item->libelle }}</a>
                                </td>
                                <td align="right">
                                    {{ \App\Models\Transaction::getNombreArticles($item->id_transaction) }} Articles
                                </td>
                                <td align="right">
                                ...
                                <td align="center">
                                    ...
                                    <a href="{{ Route('admin.transfertOUT',['p_id' => $item->id_transaction ]) }}"

...
@section('main_content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.transfertINs') }}">Liste des transferts de stock</a></li>
        ...
        <div class="col-lg-10">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" align="center">
                    ...
                    <h5>
                        <a href="{{ route('admin.magasin',['p_id'=>$transaction->id_magasin]) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($data as $trans_article)
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="{{ route('admin.article',['p_id'=>$trans_article->id_article]) }}"

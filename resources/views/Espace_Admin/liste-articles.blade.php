...
@section('title')
    @if($type == "nv") Nouveaux articles @endif
    @if($type == "v") Liste des articles @endif
    @if($type == "d") Articles effacés @endif
@endsection
...
@section('main_content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            @if($type == "nv") Nouveaux articles @endif
            @if($type == "v") Liste des articles @endif
            @if($type == "d") Articles effacés @endif</li>
    </ol>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example">
                        ...
                        @foreach( $data as $item )
                            <tr>
                                ...
                                <td align="right"><input type="checkbox" name="valide[{{ $loop->index+1 }}]"/></td>
                                <td>
